...
public class Edit_booklist_data extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_booklist_data);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Edit_booklist_data.this, "Updated Successfully!", Toast.LENGTH_SHORT).show();
